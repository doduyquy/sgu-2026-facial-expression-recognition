...
class FacialRegionDictionary(nn.Module):
    ...
    def __init__(self, num_regions=6, embed_dim=512):
        ...
        # Tokenize: mỗi vùng -> 1 vector embedding
...
# =====================================================================
# 3. Model chính: ResNetRegionAlignedFER
# =====================================================================
class ResNetRegionAlignedFER(nn.Module):
    ...
    def __init__(self, config, channels=1):
        ...
        # Project ResNet 1024-d -> 512-d để đưa vào transformer
    ...
    def freeze_backbones(self):
        ...
        self.is_frozen = True
        print("[ResNetRegionAligned] Backbone FROZEN.")

    def unfreeze_backbones(self):
        """Unfreeze everything for Phase 2."""
        for param in self.parameters(): param.requires_grad = True
        self.is_frozen = False
        print("[ResNetRegionAligned] All parameters UNFROZEN.")
    ...
    def forward(self, x):
        ...
        visual_features = self.proj_res(res_feat) # [B, 9, 512]
...
if __name__ == "__main__":
    print("=== Testing ResNetRegionAlignedFER ===")
    config = {
    ...
    model = ResNetRegionAlignedFER(config, channels=1).to(device)
    out = model(dummy)
