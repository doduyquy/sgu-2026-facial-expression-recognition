...
MODEL_REGISTRY = {
    ...
    "resnet": lambda config, **kw: ResNet50(
        ...
        landmark_logit_noise_std=config['model'].get('landmark_logit_noise_std', 0.1),
        use_multiscale_landmark_branch=config['model'].get('use_multiscale_landmark_branch', True),
        landmark_tau_start=config['model'].get('landmark_tau_start', 0.5),
        landmark_tau_mid=config['model'].get('landmark_tau_mid', 0.2),
        landmark_tau_end=config['model'].get('landmark_tau_end', 0.05),
