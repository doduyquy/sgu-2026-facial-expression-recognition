...
MODEL_REGISTRY = {
    ...
    "resnet": lambda config, **kw: ResNet50(
        ...
        landmark_tau_start=config['model'].get('landmark_tau_start', 0.2),
        landmark_tau_end=config['model'].get('landmark_tau_end', 0.05),
        landmark_center_prior_strength=config['model'].get('landmark_center_prior_strength', 0.3),
        landmark_center_prior_sigma=config['model'].get('landmark_center_prior_sigma', 0.28),
