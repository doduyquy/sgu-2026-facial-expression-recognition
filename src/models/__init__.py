...
# from .region_attetnion_ver2 import RegionAlignedFER as RegionAlignedFER_V2
...
MODEL_REGISTRY = {
    ...
    # "region_aligned_ferver2": lambda **kw: RegionAlignedFER_V2(config=kw['config'], channels=kw['config']['data']['channels']),
