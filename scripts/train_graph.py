...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        train_metrics = train_one_epoch_graph(model, train_loader, optimizer, criterion, device)
        val_metrics = evaluate_graph(model, val_loader, criterion, device)
    ...
    test_metrics = evaluate_graph(model, test_loader, criterion, device)
