...
def load_model(config_path, weights_path, device):
    ...
    model = AttentiveSCNFER(
        ...
        use_region_cross_attention=m_cfg.get("use_region_cross_attention", False),
        num_regions=m_cfg.get("num_regions", 6),
        region_attn_heads=m_cfg.get("region_attn_heads", 4),
        region_suppression_radius=m_cfg.get("region_suppression_radius", 1),
        region_gate_init=m_cfg.get("region_gate_init", 0.05),
        dropout=0.0,
