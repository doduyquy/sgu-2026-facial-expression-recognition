...
def main():
    ...
    model = AttentiveSCNFER(
        ...
        use_m4_graph=m_cfg.get("use_m4_graph", False),
        m4_num_nodes=m_cfg.get("m4_num_nodes", 8),
        m4_graph_depth=m_cfg.get("m4_graph_depth", 3),
        m4_top_k=m_cfg.get("m4_top_k", 3),
        m4_edge_heads=m_cfg.get("m4_edge_heads", 4),
        m4_gate_init=m_cfg.get("m4_gate_init", 0.0),
